...
export default function Footer() {
  return (
    <footer className="print:hidden bg-gray-50 border-t border-gray-200 mt-16">
      <div className="max-w-5xl mx-auto px-4 py-8">
        <div className="flex flex-col md:flex-row justify-between items-start gap-6">
          <div>
            <p className="font-bold text-gray-700 mb-1">TabiCheck</p>
            <p className="text-sm text-gray-500">日本人向け海外旅行準備情報サービス</p>
          </div>
