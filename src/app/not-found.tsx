...
export default function NotFound() {
  return (
    <main className="min-h-[80vh] flex items-center justify-center bg-gradient-to-b from-blue-50 via-white to-white px-4">
      <div className="text-center max-w-lg w-full">
        {/* 404 illustration */}
        <div className="relative inline-block mb-8">
          <div className="text-[90px] sm:text-[130px] md:text-[160px] font-black text-blue-100 select-none leading-none">
            404
          </div>
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center mb-10">
          ...
          <Link
            href="/countries"
            className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-6 py-3 border-2 border-gray-200 text-gray-700 rounded-xl hover:bg-gray-50 hover:border-gray-300 transition-colors font-medium"
          >
          ...
          <div className="flex flex-wrap gap-2 justify-center">
            {[
              ...
              <Link
                key={c.code}
                href={`/country/${c.code}`}
                className="text-sm text-blue-600 hover:text-blue-800 px-3 py-2 bg-blue-50 hover:bg-blue-100 rounded-full transition-colors font-medium"
              >
                {c.name}
              </Link>
            ))}
